...
while ($post = mysqli_fetch_assoc($allPosts)) {
    ...
    echo "<tr class='text-dark h5'><td class='p-0'><a class='text-dark' style='text-decoration:none; display:blocked;' href='/posts/view/$post[id]'><p class='m-0'>$post[title]</p></a></td>";
